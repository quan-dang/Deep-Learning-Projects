...
class TFAnnotation:
    def __init__(self):
        # initialize the bounding box + label list
        self.xMins = []
        self.xMaxs = []
        self.yMins = []
        self.yMaxs = []
        ...
        # initialize additional variables, i.e., image, its spatial dims, encoding and filename
        self.image = None
        self.width = None
        self.height = None
        self.encoding = None
    ...
    def build(self):
        # call TensorFlow’s encoding functions on each of the attributes
        ...
        # build a data dictionary from these encoded objects
        data = {
            "image/height": h,
            "image/width": w,
