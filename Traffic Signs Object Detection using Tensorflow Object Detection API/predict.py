...
# --model: the path to our frozen checkpoint detection graph (i.e., the TensorFlow model)
# --labels: the path to our classes.pbtxt file.
# --image:  the path to our input image that we want to apply object detection.
# --num-classes: specify number of classes
# --min-confidence (optional): the minimum probability used to filter out weak detections.
