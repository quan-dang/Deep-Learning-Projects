...
# --cascade is the path to our face detection Haar cascade
# --model is our pre-trained CNN that we will use to detect emotion
# --video is the path to the video file we want to apply emotion detection 
...
# keep looping over frames from the video pointer
while True:
    ...
    if len(rects) > 0:
        ...
        # then pre-process it for the network
