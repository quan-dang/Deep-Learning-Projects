"""
Build an autoencoder from Tensorflow/Keras
"""
...
class MODEL():
    ...
    def train_model(self):
        ...
        checkpoint = ModelCheckpoint(filepath=os.path.join(MODEL_SAVE_DIR, "train_model.h5"),
                                    verbose=0,
                                    save_best_only=True)
    ...
    def get_trained_model(self):
        ...
        self.model = load_model(MODEL_SAVE_DIR + '/train_model.h5')
